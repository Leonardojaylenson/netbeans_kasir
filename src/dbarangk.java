...
public class dbarangk extends javax.swing.JFrame {

    public dbarangk() {
        initComponents(); // Initialize components (generated by GUI designer)
...
private void getIdBarang() {
    ...
    try{
        ...
        String sql = "select barangkeluar.id_bkeluar, barang.nama_barang, barang.kode_barang, barang.harga_jual,"
                + "barangkeluar.jumlah FROM barangkeluar join barang on barangkeluar.id_barang = barang.id_barang";
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(idbarang, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        try{
            String sql = "delete from barangkeluar WHERE id_bkeluar='"+idbarang.getText()+"'";
            java.sql.Connection conn=(Connection)koneksi.configDB();
    ...
    String sql = "UPDATE barangkeluar SET id_barang = ?, jumlah = ? WHERE id_bkeluar = ?";
    Connection conn = koneksi.configDB();
...
kosong();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try {
            ...
            String sqlAnak = "INSERT INTO barangkeluar (id_barang, jumlah) VALUES (?, ?)";
            Connection conn = koneksi.configDB();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dbarangk.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
